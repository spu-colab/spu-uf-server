...
public abstract class CadastroController extends JPanel {
	...
	public void inicializar() {
		...
		// define se deve ser exibido o painel superior da janela (criado se exibir bot�es de cadastro, ou bot�es adicionais, ou painel de filtros)
		if (exibirBotoesCadastro || btnBotoesPosteriores != null || pnlFiltros != null) {
			...
			// criado o painel de bot�es se for para exibir os bot�es de cadastro ou bot�es adicionais
		...
		// verifica se o painel de campos edit�veis deve ser exibido
		...
		btnExcluir.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				int resposta = JOptionPane.showConfirmDialog(null, "ATEN��O! Esta a��o n�o poder� ser desfeita! Confirma a exclus�o dos registros selecionados?", "Confirma��o de Exclus�o", JOptionPane.YES_NO_OPTION);
