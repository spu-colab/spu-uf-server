...
import br.gov.economia.seddm.spu.controller.RequestFilter;
import br.gov.economia.seddm.spu.jwt.JwtAuthenticationEntryPoint;
		...
		httpSecurity
			...
			.csrf().disable()
				...
				.authorizeRequests()
					...
					.antMatchers(HttpMethod.GET, "/sapiens/demandas")
						.permitAll()
