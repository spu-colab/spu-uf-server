package br.gov.economia.seddm.spu.autodoc.utils;
...
public class MyUtils {
	...
	public static Properties obterPropriedades(String nomeArquivo) {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Erro ao ler o arquivo de propriedades da aplica��o. Verifique se o arquivo '" + nomeArquivo + "' existe no diret�rio da aplica��o: \n \n" + e.getMessage());
			e.printStackTrace();
		}
	...
	public static void salvarPropriedades(Properties prop, String nomeArquivo) {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Erro ao gravar o arquivo de propriedades da aplica��o. Verifique se o arquivo '" + nomeArquivo + "' existe no diret�rio da aplica��o: \n \n" + e.getMessage());
			e.printStackTrace();
		}
	}
...
//	}
	...
	public static boolean tabelaExiste(EntityManager conexao, String nomeTabela) {
		...
		String sql = "SHOW TABLES LIKE 'demanda'"; 
	...
	public static void insereOpcoesComboBox(Connection conexao, MyComboBox comboBox, String sql, List<ComboBoxItem> itensInicioLista) {
		...
		// insere os itens adicionais ao in�cio da lista
	...
	public static String verificacaoDeEspacoEmDisco(long espacoMinimo) {
		...
		if (espacoEmDisco < espacoMinimo) {
			return "O espa�o no disco " + raiz.getPath() + " � de " + espacoEmDisco + " mb. Libere pelo menos " + espacoMinimo + " mb de espa�o em disco antes de iniciar este processo.";
		} else {
			return null;
		}
	}
	...
	public static void apagarArquivo(String nomeArquivo, int numeroTentativas) throws Exception {
		...
		// verifica se, mesmo depois de exclu�do, o arquivo ainda existe; se sim, retorna erro
		if (arquivo.exists()) {
			throw new Exception ("A exclus�o do arquivo " + nomeArquivo + " falhou.");
		}
	}
	...
	public static void renomearArquivo(String nomeArquivoAnterior, String nomeArquivoNovo, int numeroTentativas, boolean adicionarNumeracao) throws Exception {
		...
		if (!arquivoNovo.exists()) {
			throw new Exception ("A movimenta��o do arquivo " + nomeArquivoAnterior + " para o arquivo " + nomeArquivoNovo + " falhou.");
		}
	}
}
